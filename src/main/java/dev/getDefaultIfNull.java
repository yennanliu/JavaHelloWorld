...
// "optional" :
// https://github.com/yennanliu/JavaHelloWorld/blob/main/src/main/java/Advances/Optional/demo1.java
// java ternary operator :
// https://yubin551.gitbook.io/java-note/basic_java_programming/operator/ternary_instanceof
...
public class getDefaultIfNull {
  ...
  public void test1() {
    ...
    // System.out.println(">>> r1.getName() = " + r1.getName().length()); //
