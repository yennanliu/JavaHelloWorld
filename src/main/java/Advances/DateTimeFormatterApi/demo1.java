 ...
 *
 *  1) for date, time formatting, parsing
 *  2) similar as simpleDateFormat
 *  3) instantiation methods
 *      3-1) default : e.g. ISO_LOCAL_DATE_TIME, ISO_LOCAL_DATE
 *      3-2) localization relative: e.g. : ofLocalizeDateTime (FormatStyle.Long. FormatStyle.MEDIUM, FormatStyle.SHORT)
 *      3-3) user-defined (common usage) : e.g. : offPattern("yyyy-mm-dd")
 */
...
public class demo1 {
    ...
    public void test1(){
        ...
        System.out.println(formatter.parse("2021-11-20T08:58:06.391899")); // {},ISO resolved to 2021-11-20T08:58:06.391899
    }
