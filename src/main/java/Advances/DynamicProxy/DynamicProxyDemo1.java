...
class MyInvocationHandler implements InvocationHandler {
  ...
  public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
    ...
    /**
     * -> method : method called by proxy class (代理類) -> called by proxied class' (被代理類) -> obj :
     * proxied class' (被代理類)
     */
 ...
 *
 * <p>Question 1) how to load proxied class from memory, and init proxy class and its instance
 * dynamically ? Question 2) when call method through proxy class, how to call same method in
 * proxied class dynamically ?
 */
