 ...
 * UDP intro & demo 1
 *
 * <p>1) DatagramSocket, DatagramPacket class help UDP program implementation 2) UDP info via
 * DatagramSocket send and receiver. -> However, system NOT Grantee when/whether such info can be
 * sent to client side
 *
 * <p>3) DatagramPacket encapsulates UDP data msg, sender ip, address, receiver ip, address are
 * included
 *
 * <p>4) Every UCP protocol has address info, so NO NEED to set up connection (with receiver),
