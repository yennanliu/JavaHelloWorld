...
public class demo3 {
    ...
    public void test2(){
        ...
        List<String> list_1 = Arrays.asList(new String[]{"aa","bb","cc"});
        ...
        List<Integer> list_4 =  Arrays.asList(new Integer[]{123, 456});
        System.out.println(list_4); // [123, 456], we need to use "Packaging class" (Integer) instead of basic data type (int)
    }
    ...
    public void test3(){
        ...
        /** iterator() :
         * return Iterator interface instance, for visiting all elements in collection,
