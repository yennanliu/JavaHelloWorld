 ...
 *
 * <p>1) CAN ONLY add SAME CLASS elements into TreeSet
 *
 * <p>2) 2 ordering types: - natural ordering - custom ordering
 *
 * <p>3) natural ordering : - compare if 2 elements are the same : "compareTo() method returns 0",
 * not using "equals()" anymore
 *
 * <p>4) custom ordering : - compare if 2 elements are the same : "compare() method returns 0", not
 * using "equals()" anymore
 *
 * <p>5) Compare "comparision" in different classes: Set, HashSet : hashCode(), equals() TreeSet :
 * compareTo(), compare()
 */
...
public class TreeSetDemo1 {
  ...
  public void test3() {
    ...
    /**
     * without param -> natural ordering (e.g. TreeSet set1 = new TreeSet();) with param -> custom
     * ordering (e.g. TreeSet set1 = new TreeSet(com);)
     */
