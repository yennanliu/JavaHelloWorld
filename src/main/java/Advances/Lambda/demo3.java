 ...
 *
 * <p>- Java's default 4 functional interfaces
 *
 * <p>- 1) Consumer interface : Consumer<T> void accept(T t)
 *
 * <p>- 2) Supplier interface: Supplier<T> T get()
 *
 * <p>- 3) Function interface: Function<T, R> R Apply(T t)
 *
 * <p>- 4) Predicate (斷言) interface: Predicate<T> boolean test(T t)
 */
public class demo3 {
