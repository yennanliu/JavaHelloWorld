 ...
 *
 * <p>1) Constructor ref -> similar as "method ref" -> lambda expression abstract method's args have
 * to be AS SAME AS Constructor's args -> lambda expression return type is SAME as Constructor's
 * type
 *
 * <p>2) array ref -> recognize array as a "special class", so use case is similar as "constructor
 * ref"
 */
