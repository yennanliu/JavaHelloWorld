 ...
 *
 * <p>1) use cases -> when op we want to pass lambda expression already been implemented
 *
 * <p>2) Method reference is "lambda expression" essentially -> (lambda expression is implementation
 * of functional interface) -> so Method reference is also implementation of functional interface
 *
 * <p>3) syntax -> class(or instance) :: method-class
 *
 * <p>4) 3 cases -> case 1: instance :: non-static-method -> case 2: class :: static-method -> case
 * 3: class: non-static-method
 *
 * <p>5) Requirement (when can use Method reference) -> interface's abstract method param and return
 * values should be AS SAME AS Method reference 's param and return values
 */
public class MethodRefTest {
   ...
   *
   * <p>-> Consumer's void accept(T t) -> PrintStream's void println(T t)
   */
  @Test
  public void test1() {
   ...
   *
   * <p>-> Supplier's T get() -> Employee's String getName()
   */
  @Test
  public void test2() {
   ...
   *
   * <p>-> Comparator's int compare(T t1, T t2) -> Integer's int compare(T t1, T t2)
   */
  @Test
  public void test3() {
  ...
  /** Example 4 -> Function's R apply(T t) -> Math's Long round(Double d) */
  @Test
  public void test4() {

    // V0 : tradition method
    Function<Double, Long> func0 =
  ...
  /**
   * Example 5 (a bit hard) -> class :: instance-method -> comparator's int compare(T t1, T t2) ->
   * String's t1.compareTo(t2) -> (if 1st arg (xx) is xx.compareTo, then we can use Method
   * reference)
   */
  @Test
  public void test5() {
  ...
  /** Example 6 -> BiPredicate's boolean test(T t1, T t2); -> String's boolean t1.equals(t2) */
  @Test
  public void test6() {
  ...
  /** Example 7 -> Function's R apply(T t) -> Employee's String getName(): */
  @Test
  public void test7() {
