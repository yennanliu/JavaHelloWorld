 ...
 * Create 2 tread
 *
 * <p>1) 1st thread : even nums in 0-100 2) 2nd thread : odd nums in 0-100
 *
 * <p>Use 2 ways run the thread
 *
 * <p>1) formal way, make instance, then use its start() method 2) via anonymous subclass
 */
