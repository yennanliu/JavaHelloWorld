...
/**
 *   Demo 2
 *      Create thread method 4 : thread pool  (change pool property)
 *
 *   * Pros
...
public class demo2 {
    public static void main(String[] args) {
        ...
        //        for getting instance from the class (ThreadPoolExecutor) that implement ExecutorService interface
