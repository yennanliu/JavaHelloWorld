...
public class demo2 {
    ...
    /**
     *  java.text.SimpleDateFormat
     *      - format and parse on the Date instance
     *
     *  1) 2 op
     *      - format : dateTime --> string
     *      - parse  : string --> dateTime
     *
     *  2) instantiate java.text.SimpleDateFormat
     */
    @Test
    public void test1() throws ParseException { // we need this ParseException, since defined format/parse pattern may be wrong
        // instantiation
        ...
        // parse  : string --> dateTime
        //String str1 = "2021-11-01"; // wrong, java.text.ParseException: Unparseable date: "2021-11-01"
