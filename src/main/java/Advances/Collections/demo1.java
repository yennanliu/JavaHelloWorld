 ...
 *    Collections demo 1
 *
 *   1) Collections is a tool class for operating data structures (e.g. Set, List, Map..) under collection
 *
 *   2) difference between Collections VS Collections ?
 *      - Collection is an interface for data structure
 *      - Collections is a tool for operating Collection
 *
 *   3) common methods
 *
 *   4) synchronizedXXX() methods
 *      -> can make implemented collection become "synchronized" collection
 *      -> so can solve thready-safety issue in multi-thread
 */
...
public class demo1 {
    ...
    public void test2(){
        ...
        Collections.copy(dest, srcList); //java.lang.IndexOutOfBoundsException: Source does not fit in dest
