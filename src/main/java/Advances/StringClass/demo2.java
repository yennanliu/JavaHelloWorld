 ...
 *
 * <p>ref : - https://github.com/yennanliu/JavaHelloWorld/blob/main/doc/pic/string_vs_new_string.png
 *
 * <p>method 1) via literal: - String str1 = "abc; - as string constant, as shared value for most
 * cases
 *
 * <p>method 2) via new + constructor: - String str2 = new String("abc"); - as string (non constant)
 * - NOTE*** : if there is a variable (e.g. s1) then this value is storage in stack space, but not
 * constant pool space - example : String s5 = s1 + "hadoop";
 */
public class demo2 {
  /** */
  @Test
  ...
  public void test2() {
    /**
     * 1) concatenation of constant and constant -> still in constant pool 2) concatenation of
     * variable and constant -> as `new`, so in stack space
     */
    ...
    String s8 =
        s5.intern(); // return value (s8) is in constant pool (the already existed value : "java")
