 ...
 *
 * <p>1) ? extends A: -> G<? extends A> : can be G<A>, and G<B>'s super class, B is A's sub class
 *
 * <p>2)? super Student2: -> G<? super A> : can be G<A>, and G<B>'s super class, B is A's super
 * class
 */
public class demo7 {
  @Test
