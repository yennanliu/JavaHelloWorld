 ...
 * demo6 : generic
 *
 * <p>1) generic with inheritance - 1-1) : class A is class B's super class, -> however, there is NO
 * super-sub class relation in G<A> and G<B> -> G<A> and G<B> are in the SAME LAYER -> plz check
 * test2 extra : A is B's super class -> A<G> is B<G>'s super class as well
 *
 * <p>2) generic type with wildcard -
 * https://docs.oracle.com/javase/tutorial/extra/generics/wildcards.html - sign : "?"
 */
public class demo6 {
