 ...
 *
 * <p>1) Buffered IO flow : for RAISING file IO efficiency -> why ? java offers "buffer space"
 ...
 *
 * <p>2) Buffered IO flow: - BufferedInputStream - BufferedOutputStream - BufferedReader -
 * BufferedFileWriter
 *
 * <p>3) "operation flow" (e.g. BufferedReader, BufferedFileWriter) is based on existing flow (e.g.
