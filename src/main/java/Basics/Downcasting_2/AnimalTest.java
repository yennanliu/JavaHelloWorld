...
public class AnimalTest {
    public static void main(String[] args){
         ...
         *    superclass p1 = new subclass();  // uppercasting
         *    // then do downcasting
         *    subclass x1 = (subclass) p1; // downcasting
         *
         *    -> then we can use instance (x1)
         *
         * 2) Note :
         *    Uppercasting : make subclass -> superclass
         *    Downcasting : make superclass -> subclass
         */
