...
public class AnimalTest {
  ...
  // method
  /**
   * Can use Polymorphism below : -> Animal animal = new Dog(); -> instantiate with animal
   * superclass, but implement with Dog subclass when runtime -> will use subclass' OVERRIDE eat,
   * shout methods
   */
