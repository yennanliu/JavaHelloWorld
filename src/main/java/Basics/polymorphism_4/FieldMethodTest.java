...
public class FieldMethodTest {
    public static void main(String[] args){
        ...
        /**
         * Note :
         * 1) if subclass Override superclass' method
         *      -> will only use method in subclass
         * 2) But, above case NOT work for attr
         *      -> e.g. polymorphism NOT working on attr
         *      -> attr will still use superclass' attr
         *      -> example :
         *      -> Base b = s;
         *      -> b.count // Base's count
         */
