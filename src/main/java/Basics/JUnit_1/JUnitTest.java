 ...
 * <p>Steps :
 *
 * <p>1) add library -> JUnit (JUnit4) - for intelliJ :
 * https://www.jetbrains.com/help/idea/library.html#lib_levels
 *
 * <p>2) create a java class for unit test - requirement of the java class - 1. public class - 2.
 ...
 *
 * <p>3) need to add @Test over the test method, and import the corresponding library
 *
 * <p>4) after creating the test method, write the test code
 *
 * <p>5) after finishing the test code -> click "run JUnit test"
 *
 * <p>6) if there is no exception -> green else -> red, and with error/exception msg
 */
