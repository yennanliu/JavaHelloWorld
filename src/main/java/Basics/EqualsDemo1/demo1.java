 ...
 *   1) ==
 *      1-1) ==, an operator
 *      1-2) can be used on basic data type and inference data type
 *      1-3) type doesn't matter,
 *           -> == is Comparing their "actual value" in memory
 *
 *      1-4) If compare "basic data type"
 *           -> type don't need to be the same, ONLY compare their "actual value" in memory
 *
 *      1-5) If compare "REFERENCE data type"
...
public class demo1 {
    public static void main(String[] args){
        ...
        System.out.println(str1 == str2); // FALSE, same as above, str1 and str2 are in different address
    }
}
