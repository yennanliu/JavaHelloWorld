 ...
 *
 *   1) use proxy class instead of the actual "true" class
 *   2) using case:
 ...
 *
 *   3) Types
 *      - static proxy (this example)
 *      - dynamic proxy -> "java reflection", we will cover this later
 */
...
public class ProxyDemo1 {
    public static void main(String[] args) {
        ...
        /**
         *   NOTE : we're not explicitly using Server class below,
         *   but we run browse method via "proxy" (e.g. proxyServer) class
         */
        proxyServer.browse();
    }
}
