...
/**
 *   Do student score transform via Vector (replace Array)
 *   And get the scores by level (Rank A, B ...)
 *
 *   Note : Different from Array, length of Vector is dynamic
 *
 *    1) Vector v = new Vector();
 *    2) v.addElement(Object obj);
...
public class ScoreTest {
    ...
    public static void main(String[] args) {
        ...
        // step 5) go through Vector for getting each student's score, and compare with highest and get rank
        char level;
