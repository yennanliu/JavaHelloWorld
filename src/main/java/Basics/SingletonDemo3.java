 ...
 *    -> check below steps
 *
 *  3) private static Order2 instance = null;  // *** MAIN DIFFERENCE WITHIN EAGER & LAZY initialization (lazy : doesn't create at this stage)
 */
...
class Order2{
    ...
    private static Order2 instance = null;  // *** MAIN DIFFERENCE WITHIN EAGER & LAZY initialization (lazy : doesn't create at this stage)
