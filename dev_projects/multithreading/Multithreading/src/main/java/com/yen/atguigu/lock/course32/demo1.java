 ...
 *
 * <p>-> Write lock CAN downgrade to read lock
 *
 * <p>step 1) get write lock step 2) get read lock step 3) release write lock (downgrade write lock
 * to read lock) step 4) release read lock
 *
 * <p>(CAN read while write)
 */
...
public class demo1 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "---> get read lock"); // NOTE !!! we can still read while write :
                               // https://youtu.be/tlaBTB2eZzY?si=8JCmiXK-v16QpkLo&t=539
