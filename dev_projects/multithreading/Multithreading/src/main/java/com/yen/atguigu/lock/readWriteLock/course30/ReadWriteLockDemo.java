...
public class ReadWriteLockDemo {
  ...
  public static void main(String[] args) throws InterruptedException {
     ...
     *
     * <p>-> NOT correct, ONLY can read after put data completed
     *
     * <p>log : 1 get data !! key = 1 2 put data !! key = 2 3 get data !! key = 3 4 get data !! key
     * = 4 1 put data !! key = 1 0 get data !! key = 0 0 put data !! key = 0 3 put data !! key = 3 4
     * put data !! key = 4 2 get data !! key = 2 4 put data done. key = 4 0 get data done. key = 0 0
     * put data done. key = 0 1 get data done. key = 1 1 put data done. key = 1 3 put data done. key
     * = 3 2 put data done. key = 2 3 get data done. key = 3 4 get data done. key = 4 2 get data
     * done. key = 2
     */
  }
}
